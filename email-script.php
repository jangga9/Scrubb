...
if (isset($_POST['sendMailBtn'])) {
    ...
    $run_payment = mysqli_query($conn,$insert);

    $insert2 = "INSERT INTO payment
     (CustomerID,Card_Holder_Name,
     Card_Number,
     Exp_Month,
     Exp_Year,CCV)
     VALUES
                  ...
                  <tr>
                    <td class="content-cell">
                      ...
                      <h1>'.$subjectName.'</h1><br/>
                        <p>Thanks for purchasing Scrubb Gift Card. This email is the receipt for your purchase. No payment is due.</p>
                          ...
                          <tr>
                            <td colspan="2">
                              <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td width="80%" class="purchase_item"><h1>'.$message.'</h1></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">&copy; 2022 Scrubb. All rights reserved.</p>
                      <p class="f-fallback sub align-center">
                        <br>Scrubb Home Improvement and Maintenance
                        <br>Klang Valley, Selangor.
                        <br>helloscrubb@gmail.com
                      </p>
                    </td>
                  </tr>
                </table>
